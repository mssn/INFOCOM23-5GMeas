...
%				anchor=north west,
			...
			%xticklabels={R1,R2,R3,R4,R5,R6,R7,R8,R9,R10,R11,R12,R13},
			xticklabels={677,1123,39874,40072,66736,66811,67011},
			%xticklabels={925,1100,2050,2561,5230,66536,66586,66836,67086},
			...
			%\legend{5GM,5GS,4G}
			\legend{5GM (n260/n261),5GS (n41), 5GS (n5/n66/n71), 4G only}
			...
			line color = blue,
			area legend
			]table[x=x,y=5gm,col sep=comma,]{T_pcell_channel_rat.csv}; %instance_stat_rat_0405-1226_0.0005_wrong_instance_v2.csv};
			...
			line color = black,
			area legend
			]table[x=x,y=n41,col sep=comma,]{T_pcell_channel_rat.csv}; %instance_stat_rat_0405-1226_0.0005_wrong_instance_v2.csv};
			...
			line color = black,
			area legend
			]table[x=x,y=n71,col sep=comma,]{T_pcell_channel_rat.csv};
%			
			\addplot+[
			...
			line color = red,
			area legend
			]table[x=x,y=4g,col sep=comma,]{T_pcell_channel_rat.csv}; %instance_stat_rat_0405-1226_0.0005_wrong_instance_v2.csv};
%			
%			\addplot+[
