...
%				anchor=north west,
			...
			line color = blue,
			area legend
			]table[x=x,y=5gm,col sep=comma,]{V_pcell_channel_rat.csv}; %instance_stat_rat_0405-1226_0.0005_wrong_instance_v2.csv};
			...
			line color = black,
			area legend
			]table[x=x,y=5gs,col sep=comma,]{V_pcell_channel_rat.csv}; %instance_stat_rat_0405-1226_0.0005_wrong_instance_v2.csv};
%			
			\addplot+[
			...
			line color = red,
			area legend
			]table[x=x,y=4g,col sep=comma,]{V_pcell_channel_rat.csv}; %instance_stat_rat_0405-1226_0.0005_wrong_instance_v2.csv};
%			
%			\addplot+[
