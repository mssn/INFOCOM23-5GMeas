...
% R4
%%		restrict x to domain=-87.684:-87.666,
%		ymax    = 41.886, %39.781,
%		ymin    = 41.877, %39.761,
%		xmin = -87.684, %-86.168,
%		xmax = -87.666, %-86.145,
%		width   = 3.13cm, %4cm,
%		height  = 2.04cm, %4.53cm,
...
\begin{document}
	...
	\begin{tikzpicture}
		\begin{axis}[
		%restrict x to domain=-87.684:-87.666,
		restrict x to domain=-87.688:-87.665,
		ymax    = 41.89, %41.886, %39.781,
		ymin    =  41.87, %41.877, %39.761,
		xmin = -87.688, %-87.684, 
		xmax =-87.665, % -87.666, %-86.145,
		width   = 4cm, %3.13cm, %4cm,
		height  = 4.5cm, %2.04cm, %4.53cm,
		...
		colorbar style={
			...
			{A-R4_connectivity_ratio_pixel5_20210405_20211226_310410_0.0005_0_0_0.9_0.1_grid_passed.csv};
...
\draw[line width=0.2mm, black,-,>=latex] (axis cs:-87.684,41.886) to (axis cs:-87.666,41.886);
\draw[line width=0.2mm, black,-,>=latex] (axis cs:-87.666,41.886) to (axis cs:-87.666,41.877);
\draw[line width=0.2mm, black,-,>=latex] (axis cs:-87.666,41.877) to (axis cs:-87.684,41.877);
\draw[line width=0.2mm, black,-,>=latex] (axis cs:-87.684,41.877) to (axis cs:-87.684,41.886);
%\node[text=black] at (axis cs:-86.158,39.779) {R6 (1.9 Km x 1.4 Km)};
\node[text=black, right] at (axis cs:-87.685,41.889) {R4 (A): 5G = $5G_s$};
\node[text=black, right] at (axis cs:-87.685,41.887) {($5G_m$ not used)};
