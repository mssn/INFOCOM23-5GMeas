clc;clear;
load('/Users/yanbingliu/ownCloud/5G-INDY/paper/pgfplots/map-cell-num/A-R5_grid_cell_num.csv.mat')
...
set(gca,'color','none');
colorbar off
saveas(gca, '/Users/yanbingliu/ownCloud/5G-INDY/paper/pgfplots/map-cell-num/R5-map-cell-num.eps','epsc')