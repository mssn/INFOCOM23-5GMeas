...
] {T_Sub6_instance_duration_pixel5_20210405_20211226_310260_0.0005_0_area_type.csv};
...
x expr = \thisrowno{0},
y expr = \thisrowno{1}*100,
] {T_LTE_instance_duration_pixel5_20210405_20211226_310260_0.0005_0_area_type.csv};

%\node[font=\large] at (axis cs: 30,20) {\textbf{AT\&T(A)}};
\node[font=\normalsize] at (axis cs: 0.3,90) {\textbf{(T)}};
\draw[line width=0.7mm, red,dashed] (axis cs:0.1,52.3) to (axis cs:1,52.3);
\draw[line width=0.7mm, red,dashed] (axis cs:1,0) to (axis cs:1,52.3);
%\legend{4G,5GS,5GM};
\legend{5GS,4G};
%\legend{Set};
