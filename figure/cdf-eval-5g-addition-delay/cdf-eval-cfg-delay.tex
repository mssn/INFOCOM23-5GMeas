...
\begin{tikzpicture}
    \begin{axis}[
           ...
           %xtick = {1, 10, 100},
            ...
            xlabel={Configuration delay (sec)},
            ylabel={CDF (\%)},
            ylabel style={
                font=\normalsize,
		...
		col sep=comma,
		] {A_design_eval_cfg_delay_cdf_20210405_20211226_310410.csv}; 
        ...
        y expr = \thisrowno{1} * 100,
        col sep=comma,
        ] {V_design_eval_cfg_delay_cdf_20210405_20211226_311480.csv}; 
        ...
        y expr = \thisrowno{1} * 100,
        col sep=comma,
        ] {V_cfg_delay_cdf_all.csv};
        
       %{delta_cdf.txt};
       \legend{{\bf \texttt{A} \texttt{5GBoost}}, {\bf \texttt{A}} legacy, {\bf \texttt{V} \texttt{5GBoost}}, {\bf \texttt{V}} legacy};
