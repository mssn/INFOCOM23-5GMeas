clc;clear;
load('/Users/yanbingliu/ownCloud/5G-INDY/paper/figure_graffle/map-INFOCOM/bw-eval/A-R1_bw_gain_grid.csv.delta.mat')
...
%mycolormap = customcolormap([0 0.4375 0.5 0.6875 1], {'#0000ff', '#00ffff', '#dcf0dc', '#ffff00', '#ff0000'});
...
saveas(gca, '/Users/yanbingliu/ownCloud/5G-INDY/paper/figure_graffle/map-INFOCOM/bw-eval/map-bw-eval-delta-r1.eps','epsc')